...
with open('IIOT3-B/topics.txt') as f:
    topics = f.readlines()
...
client.tls_set(ca_certs="/home/odroid/IIOT3-B/TLSTools/ca.crt", certfile="/home/odroid/IIOT3-B/TLSTools/client01.crt",
                    keyfile="/home/odroid/IIOT3-B/TLSTools/client01.key", cert_reqs=ssl.CERT_NONE,
