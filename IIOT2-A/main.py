...
with open('IIOT2-A/topics.txt') as f:
    topics = f.readlines()
...
client.tls_set(ca_certs="/home/odroid/IIOT2-A/TLSTools/ca.crt", certfile="/home/odroid/IIOT2-A/TLSTools/client01.crt",
                    keyfile="/home/odroid/IIOT2-A/TLSTools/client01.key", cert_reqs=ssl.CERT_NONE,
