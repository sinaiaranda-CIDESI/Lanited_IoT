...
with open('IIOT1-GENERAL/topics.txt') as f:
    topics = f.readlines()
...
client.tls_set(ca_certs="/home/odroid/IIOT1-GENERAL/TLSTools/ca.crt", certfile="/home/odroid/IIOT1-GENERAL/TLSTools/client01.crt",
                    keyfile="/home/odroid/IIOT1-GENERAL/TLSTools/client01.key", cert_reqs=ssl.CERT_NONE,
